...
std::ostream& operator<<(std::ostream& out, const Statistics& obj) {
  ...
  out << "Statistics(";
  out << "max="; (obj.__isset.max ? (out << to_string(obj.max)) : (out << "<null>"));
  out << ", " << "min="; (obj.__isset.min ? (out << to_string(obj.min)) : (out << "<null>"));
  out << ", " << "null_count="; (obj.__isset.null_count ? (out << to_string(obj.null_count)) : (out << "<null>"));
  out << ", " << "distinct_count="; (obj.__isset.distinct_count ? (out << to_string(obj.distinct_count)) : (out << "<null>"));
  out << ")";
  return out;
}
...
std::ostream& operator<<(std::ostream& out, const SchemaElement& obj) {
  ...
  out << ", " << "type_length="; (obj.__isset.type_length ? (out << to_string(obj.type_length)) : (out << "<null>"));
  out << ", " << "repetition_type="; (obj.__isset.repetition_type ? (out << to_string(obj.repetition_type)) : (out << "<null>"));
  out << ", " << "name=" << to_string(obj.name);
  out << ", " << "num_children="; (obj.__isset.num_children ? (out << to_string(obj.num_children)) : (out << "<null>"));
  out << ", " << "converted_type="; (obj.__isset.converted_type ? (out << to_string(obj.converted_type)) : (out << "<null>"));
  out << ", " << "scale="; (obj.__isset.scale ? (out << to_string(obj.scale)) : (out << "<null>"));
  out << ", " << "precision="; (obj.__isset.precision ? (out << to_string(obj.precision)) : (out << "<null>"));
  out << ", " << "field_id="; (obj.__isset.field_id ? (out << to_string(obj.field_id)) : (out << "<null>"));
  out << ")";
  return out;
}
...
std::ostream& operator<<(std::ostream& out, const DataPageHeader& obj) {
  using apache::thrift::to_string;
  out << "DataPageHeader(";
  out << "num_values=" << to_string(obj.num_values);
  out << ", " << "encoding=" << to_string(obj.encoding);
  out << ", " << "definition_level_encoding=" << to_string(obj.definition_level_encoding);
  out << ", " << "repetition_level_encoding=" << to_string(obj.repetition_level_encoding);
  out << ", " << "statistics="; (obj.__isset.statistics ? (out << to_string(obj.statistics)) : (out << "<null>"));
  out << ")";
  return out;
}
...
std::ostream& operator<<(std::ostream& out, const DictionaryPageHeader& obj) {
  ...
  out << "num_values=" << to_string(obj.num_values);
  out << ", " << "encoding=" << to_string(obj.encoding);
  out << ", " << "is_sorted="; (obj.__isset.is_sorted ? (out << to_string(obj.is_sorted)) : (out << "<null>"));
  out << ")";
  return out;
}
...
std::ostream& operator<<(std::ostream& out, const DataPageHeaderV2& obj) {
  ...
  out << "num_values=" << to_string(obj.num_values);
  out << ", " << "num_nulls=" << to_string(obj.num_nulls);
  out << ", " << "num_rows=" << to_string(obj.num_rows);
  out << ", " << "encoding=" << to_string(obj.encoding);
  out << ", " << "definition_levels_byte_length=" << to_string(obj.definition_levels_byte_length);
  out << ", " << "repetition_levels_byte_length=" << to_string(obj.repetition_levels_byte_length);
  out << ", " << "is_compressed="; (obj.__isset.is_compressed ? (out << to_string(obj.is_compressed)) : (out << "<null>"));
  out << ", " << "statistics="; (obj.__isset.statistics ? (out << to_string(obj.statistics)) : (out << "<null>"));
  out << ")";
  return out;
}
...
std::ostream& operator<<(std::ostream& out, const PageHeader& obj) {
  ...
  out << ", " << "uncompressed_page_size=" << to_string(obj.uncompressed_page_size);
  out << ", " << "compressed_page_size=" << to_string(obj.compressed_page_size);
  out << ", " << "crc="; (obj.__isset.crc ? (out << to_string(obj.crc)) : (out << "<null>"));
  out << ", " << "data_page_header="; (obj.__isset.data_page_header ? (out << to_string(obj.data_page_header)) : (out << "<null>"));
  out << ", " << "index_page_header="; (obj.__isset.index_page_header ? (out << to_string(obj.index_page_header)) : (out << "<null>"));
  out << ", " << "dictionary_page_header="; (obj.__isset.dictionary_page_header ? (out << to_string(obj.dictionary_page_header)) : (out << "<null>"));
  out << ", " << "data_page_header_v2="; (obj.__isset.data_page_header_v2 ? (out << to_string(obj.data_page_header_v2)) : (out << "<null>"));
  out << ")";
  return out;
}
...
std::ostream& operator<<(std::ostream& out, const SortingColumn& obj) {
  using apache::thrift::to_string;
  out << "SortingColumn(";
  out << "column_idx=" << to_string(obj.column_idx);
  out << ", " << "descending=" << to_string(obj.descending);
  out << ", " << "nulls_first=" << to_string(obj.nulls_first);
  out << ")";
  return out;
}
...
std::ostream& operator<<(std::ostream& out, const PageEncodingStats& obj) {
  ...
  out << "page_type=" << to_string(obj.page_type);
  out << ", " << "encoding=" << to_string(obj.encoding);
...
std::ostream& operator<<(std::ostream& out, const ColumnMetaData& obj) {
  ...
  out << "ColumnMetaData(";
  out << "type=" << to_string(obj.type);
  out << ", " << "encodings=" << to_string(obj.encodings);
  out << ", " << "path_in_schema=" << to_string(obj.path_in_schema);
  out << ", " << "codec=" << to_string(obj.codec);
  out << ", " << "num_values=" << to_string(obj.num_values);
  out << ", " << "total_uncompressed_size=" << to_string(obj.total_uncompressed_size);
  out << ", " << "total_compressed_size=" << to_string(obj.total_compressed_size);
  out << ", " << "key_value_metadata="; (obj.__isset.key_value_metadata ? (out << to_string(obj.key_value_metadata)) : (out << "<null>"));
  out << ", " << "data_page_offset=" << to_string(obj.data_page_offset);
  out << ", " << "index_page_offset="; (obj.__isset.index_page_offset ? (out << to_string(obj.index_page_offset)) : (out << "<null>"));
  out << ", " << "dictionary_page_offset="; (obj.__isset.dictionary_page_offset ? (out << to_string(obj.dictionary_page_offset)) : (out << "<null>"));
  out << ", " << "statistics="; (obj.__isset.statistics ? (out << to_string(obj.statistics)) : (out << "<null>"));
  out << ", " << "encoding_stats="; (obj.__isset.encoding_stats ? (out << to_string(obj.encoding_stats)) : (out << "<null>"));
  out << ")";
  return out;
}
...
std::ostream& operator<<(std::ostream& out, const ColumnChunk& obj) {
  using apache::thrift::to_string;
  out << "ColumnChunk(";
  out << "file_path="; (obj.__isset.file_path ? (out << to_string(obj.file_path)) : (out << "<null>"));
  out << ", " << "file_offset=" << to_string(obj.file_offset);
  out << ", " << "meta_data="; (obj.__isset.meta_data ? (out << to_string(obj.meta_data)) : (out << "<null>"));
  out << ")";
  return out;
}
...
std::ostream& operator<<(std::ostream& out, const RowGroup& obj) {
  ...
  out << ", " << "total_byte_size=" << to_string(obj.total_byte_size);
  out << ", " << "num_rows=" << to_string(obj.num_rows);
  out << ", " << "sorting_columns="; (obj.__isset.sorting_columns ? (out << to_string(obj.sorting_columns)) : (out << "<null>"));
  out << ")";
  return out;
}
...
std::ostream& operator<<(std::ostream& out, const FileMetaData& obj) {
  ...
  out << ", " << "num_rows=" << to_string(obj.num_rows);
  out << ", " << "row_groups=" << to_string(obj.row_groups);
  out << ", " << "key_value_metadata="; (obj.__isset.key_value_metadata ? (out << to_string(obj.key_value_metadata)) : (out << "<null>"));
  out << ", " << "created_by="; (obj.__isset.created_by ? (out << to_string(obj.created_by)) : (out << "<null>"));
  out << ")";
  return out;
}
