...
```
git remote add apache-github git@github.com:apache/incubator-parquet-cpp.git
git remote add apache https://git-wip-us.apache.org/repos/asf/incubator-parquet-cpp.git
```
