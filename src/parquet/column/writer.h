...
class PARQUET_EXPORT ColumnWriter {
 ...
 protected:
  ...
  int64_t RleEncodeLevels(std::shared_ptr<ResizableBuffer> dest_buffer,
  ...
  std::shared_ptr<PoolBuffer> definition_levels_rle_;
  std::shared_ptr<PoolBuffer> repetition_levels_rle_;
