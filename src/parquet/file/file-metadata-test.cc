...
TEST(Metadata, TestBuildAccess) {
  ...
  ASSERT_EQ(stats_float.min, rg1_column2->statistics()->EncodedMin());
  ASSERT_EQ(stats_float.max, rg1_column2->statistics()->EncodedMax());
  ASSERT_EQ(float_min, rg1_column2->statistics()->as<FloatStatistics>()->min());
  ASSERT_EQ(float_max, rg1_column2->statistics()->as<FloatStatistics>()->max());
  ASSERT_EQ(stats_int.min, rg1_column1->statistics()->EncodedMin());
  ASSERT_EQ(stats_int.max, rg1_column1->statistics()->EncodedMax());
  ASSERT_EQ(int_min, rg1_column1->statistics()->as<Int32Statistics>()->min());
  ASSERT_EQ(int_max, rg1_column1->statistics()->as<Int32Statistics>()->max());
  ...
  ASSERT_EQ(stats_float.min, rg2_column2->statistics()->EncodedMin());
  ASSERT_EQ(stats_float.max, rg2_column2->statistics()->EncodedMax());
  ASSERT_EQ(float_min, rg1_column2->statistics()->as<FloatStatistics>()->min());
  ASSERT_EQ(float_max, rg1_column2->statistics()->as<FloatStatistics>()->max());
  ASSERT_EQ(stats_int.min, rg1_column1->statistics()->EncodedMin());
  ASSERT_EQ(stats_int.max, rg1_column1->statistics()->EncodedMax());
